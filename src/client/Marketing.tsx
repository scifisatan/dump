  ...
  return (
    <div className="marketing">
      <header className="marketing-nav">
        ...
        <a href="#how-it-works" className="marketing-about">
      ...
      <main>
        <section className="marketing-hero">
          ...
          <h1>
            ...
            <br />
            <span>Not holding onto them.</span>
          </h1>
          <p>
            The book someone mentioned. A half-formed idea. That link for later.
            <br className="desktop-label" /> Put it all in Dump. Give it a home when you feel like
            it.
          </p>
          ...
          <small>Capture first. Organize optionally.</small>
        </section>
        <section
          ...
          <div className="preview-body">
            ...
            <div className="preview-columns">
              {[
                ...
                <div key={column.name}>
                  <h2>
                    <span className="list-dot" style={{ background: column.color }} />
                    {column.name}
                    <span>2</span>
                  </h2>
                  {column.items.map((item) => (
                    <div className="preview-card" key={item}>
                      {item}
                      <small>Saved for a quieter moment</small>
                    </div>
                  ))}
                </div>
              ))}
        ...
        <section className="marketing-features" id="how-it-works">
          <div>
            <Inbox size={23} />
            <span>01 — LET IT OUT</span>
            <h2>One box. Anything goes.</h2>
            <p>
              Thoughts, links, to-dos, or a sentence that isn’t quite an idea yet. No form to fill
              out. Just get it down.
            </p>
          </div>
          <div>
            <Layers3 size={23} />
            <span>02 — MAKE A LITTLE ROOM</span>
            <h2>A place, at your pace.</h2>
            <p>
              Leave things in your inbox or make your own lists. See them side by side, arranged the
              way your mind works.
            </p>
          </div>
          <div>
            ...
            <p>
              Search for the thought you almost forgot. Capture offline on a previously loaded
              device, and sync when you’re back.
            </p>
          </div>
        </section>
        <section className="marketing-outro">
          <Asterisk size={45} />
          <h2>
            Less to carry.
            <br />
          ...
          <p>This is a personal project. The current deployment is public.</p>
        </section>
      </main>
